                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" required placeholder="Create Username" name="username" id="username" value="">
                                            ...
                                            <div class="col-xl-4 mb-3">
                                                ...
                                                <input type="text" class="form-control" required placeholder="Enter Company Code" name="company_url" id="company_url" value="" />
                                            </div>
                                            <div class="col-xl-4 mb-3">
                                            ...
                                            <div class="col-xl-4 mb-3">
                                                ...
                                                <input type="number" class="form-control" required placeholder="Enter Mobile No" name="mobile_no" id="mobile_no" />
                                            </div>
                                            <div class="col-xl-4 mb-3">
