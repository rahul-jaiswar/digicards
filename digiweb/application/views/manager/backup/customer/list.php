	                            ...
	                            <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
	                                ...
	                                <tbody>
	                                    ...
	                                    <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('Customer/card/'.$data->customerUID)?>" class="btn btn-success btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Update Card"><i class="uil-apps"></i></a>
