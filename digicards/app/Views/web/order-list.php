...
<head>
    ...
    <link href="<?=site_url('public/assets/libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css')?>" rel="stylesheet">
    <!-- DataTables -->
    <link href="<?=site_url('public/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css')?>" rel="stylesheet" type="text/css" />

    <!-- Responsive datatable examples -->
    <link href="<?=site_url('public/assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css')?>" rel="stylesheet" type="text/css" />
</head>
        ...
        <div class="page-content">
            <div class="container-fluid">
                <form class="d-inline-flex mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button type="button" class="btn btn-primary"><i class="mdi mdi-filter-variant"></i> Apply Filter</button>
                        </div>
                    </div>
                </form>
                <hr>
...
<script src="<?=site_url('public/assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js')?>"></script>
