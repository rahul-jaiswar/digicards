        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?= site_url('Account/index')?>">Summary</a></li>
                        <li><a href="<?=site_url('Order/list')?>">Order List</a></li>
                        <li><a href="<?=site_url('Expenses/list')?>">Expenses</a></li>
                        <li><a href="<?=site_url('Expenses/voucher')?>">Voucher</a></li>
                        <li><a href="<?=site_url('Account/transaction')?>">Transaction</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
