                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="row mt-2 mb-2 me-2">
                                ...
                                <div class="col-xl-2"> 
                                    <a href="<?= site_url('Customer/add')?>" class="btn btn-success waves-effect waves-light float-end"><i class="mdi mdi-plus"></i> Add New Customer</a>
                                </div>
                            </div>
                        </div> <!-- end card-->
                    </div> <!-- end col-->
				            ...
				            <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
				                ...
				                <tbody>
				                    ...
				                    <tr>
				                        ...
				                        <td>
				                            <a href="<?= site_url('Customer/card/'.$data['company_code'])?>" class="btn btn-success btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Add Card"><i class="uil-apps"></i></a>
				                            <a href="<?= site_url('Customer/update')?>" class="btn btn-success btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit Customer"><i class="uil-edit"></i></a>
