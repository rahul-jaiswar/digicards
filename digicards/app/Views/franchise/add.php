                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="font-size-16 mb-1">General Info</h5>
                                                <p class="text-muted text-truncate mb-0">Setup New Franchise on Custom URL/Tap Savvy</p>
                                            </div>
                            ...
                            <div class="col">
                                <div class="text-sm-end mt-2 mt-sm-0">
                                    <a href="#" class="btn btn-success">
                                        <i class="uil uil-user me-1"></i> Register </a>
                                </div>
                            </div> <!-- end col -->
                        </div> <!-- end row-->
                    </div>
