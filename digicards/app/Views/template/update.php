                                            ...
                                            <div class="row">
                                                <div class="col-12">
	                                                <div class="product-img">
                                                        <iframe src="<?php echo $card_url.'/'.$template['temp_name'];?>" style="height: 500px;width: 100%;"></iframe>
	                                                </div>
                                                </div>
                                            </div>
                                            <div class="row text-center mt-2">
                                                <div class="col-sm-6 d-grid">
                                                    <a href="<?php echo $card_url.'/'.$template['temp_name'];?>" class="btn btn-primary btn-block waves-effect waves-light mt-2 me-1" target="_blank"><i class="uil uil-eye me-2"></i> Preview
                                                    </a>
                                                </div>
                                                <div class="col-sm-6 d-grid">
