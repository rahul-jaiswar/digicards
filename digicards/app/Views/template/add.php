                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="row mt-2 mb-2 me-2">
                                ...
                                <div class="col-xl-4"> 
                                    <a href="" class="btn btn-success waves-effect waves-light float-end"  data-bs-toggle="modal" data-bs-target="#addcategory"><i class="mdi mdi-plus"></i> Add Template Category</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= site_url('Template/deleteTemp/'.$data->template_id)?>" class="btn btn-danger btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete Template"><i class="uil-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php endif; ?>
