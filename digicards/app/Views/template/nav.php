                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="row mt-2 mb-2 me-2">
                                ...
                                <div class="col-xl-4"> 
                                    <a href="" class="btn btn-success waves-effect waves-light float-end"  data-bs-toggle="modal" data-bs-target="#addcategory"><i class="mdi mdi-plus"></i> Add Navigation Category</a>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Add Navigation Category</h5>
                                ...
                                <form class="custom-validation" action="<?=site_url('Template/navigation')?>" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 mb-3">
                                            <label class="form-label">Navigation Category Name</label>
                                            <select class="form-select form-control" name="nav_cat" id="nav_cat" required>
                                                <option value="">Select Template Category Name</option>
                                                <?php if($navcat):?>
                                                <?php foreach($navcat as $data):?>
                            ...
                            <div class="card-body">
                                <table id="category" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $details->temp_cat?></td>
                                            <td>Active</td>
                                            <td>
                                                <a href="" class="btn btn-success btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Update Template"><i class="uil-edit"></i></a>
                                                <a href="<?= site_url('Template/delNavCat/'.$details->temp_cat)?>" class="btn btn-danger btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete Template"><i class="uil-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php endif; ?>
