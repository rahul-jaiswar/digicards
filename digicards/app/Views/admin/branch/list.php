                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="row mt-2 mb-2 me-2">
                                ...
                                <div class="col-xl-2"> 
                                    <a href="<?= site_url('Branch/add')?>" class="btn btn-success waves-effect waves-light float-end"><i class="mdi mdi-plus"></i> Add Branch</a>
                                </div>
                                ...
                                <table id="customer" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>SSNL</td>
                                            <td>Medium</td>
                                            <td>rahul@ssnl.com</td> 
                                            <td>nidhilimited@gmail.com</td>
                                            <td>7738925170</td>
                                            <td>Today</td>
                                            <td>
                                                <a href="" class="btn btn-success btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Branch Details"><i class="uil-chart-line"></i></a>
